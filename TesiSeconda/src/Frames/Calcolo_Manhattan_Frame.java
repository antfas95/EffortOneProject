...
public class Calcolo_Manhattan_Frame extends JFrame {
	...
	public Calcolo_Manhattan_Frame(GestoreStruttura gestore, ArrayList<Variabile> variabili, int intero) {
	...
	private void createSudPanel() {
		...
		class Operazione_Elabora implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				...
				progetti_ritornati= gestore.distanza_Manhattan(variabili_selezionate, k);
				createCentralPanel();
			}
		}
