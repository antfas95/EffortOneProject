...
public class IndicazioniFrame extends JFrame {
	...
	private void createCentralPanal() {
		...
		JLabel label1= new JLabel("1) Il file da leggere deve essere di formato AARFF; ");
		JLabel label2= new JLabel("1) L'ultimo elemento del file deve riguardare l'effort del progetto; ");
